...
const contractABI = require("../artifacts/contracts/Rustfoundrykit.sol/Rustfoundrykit.json").abi;

program
    .name("rustfoundrykit-cli")
    .description("CLI tool for Rustfoundrykit smart contract")
    .version("1.0.0");
